...
<div align="left">
      <blockquote>
        <h3><span class="style1">&nbsp;&nbsp;&raquo;&nbsp;</span>Editar Parceiro </h3>
  </blockquote>
</div>
...
$banner = ($_POST['banner']);
if($_POST['envia']) {
$query = "UPDATE parceiros SET nome='$nome',url='$url',banner='$banner' WHERE id='$id'";
mysql_query($query) or die(mysql_error());
echo "<script>location.href='index.php?abrir=pagEditParceiros&id=$id&msg=sucesso'</script>";}
?>
<?php
$id = $_GET['id'];
$resultado = mysql_query("SELECT*FROM parceiros WHERE id='$id'");

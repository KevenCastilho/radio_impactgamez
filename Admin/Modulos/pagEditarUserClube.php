...
-->
      ...
      <blockquote>
        <h3><span class="style1">&nbsp;&nbsp;&raquo;&nbsp;</span>Editar Usuário do Clube</h3>
  </blockquote>
</div>
...
?>
<form name="envia" action="index.php?abrir=pagEditarUserClube&id=<? echo $id ?>" method="post" name="envia">
<table width="800" border="0">
  ...
  <tr>
    ...
    <td><input name="bairro" value="<? echo $bairro?>" type="text" class="text-input small-input"/></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input name="twitter" type="text" id="twitter" value="<? echo $twitter?>" class="text-input small-input" /></td>
      ...
      <td><input name="acha" type="text" id="acha" value="<? echo $acha?>" class="text-input small-input" /></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
...
if($_POST['envia']) {
$query = "UPDATE usuarios_clube SET login='$login',nome='$nome',senha='$senha',sexo='$sexo',nick='$nick',dia='$dia',mes='$mes',ano='$ano',estado='$estado',cidade='$cidade',bairro='$bairro',msn='$msn',skype='$skype',orkut='$orkut',twitter='$twitter',relacionamento='$relacionamento',estilo='$estilo',conheceu='$conheceu',acha='$acha' WHERE id='$id'";
mysql_query($query) or die(mysql_error());
echo "<script>location.href='index.php?abrir=pagEditarUserClube&id=$id&msg=sucesso';</script>
";}
?>
<?php

...
<div align="left">
      <blockquote>
        <h3><span class="style1">&nbsp;&nbsp;&raquo;&nbsp;</span>Alterar Gato </h3>
  </blockquote>
</div>
...
<?
$resultado = mysql_query("SELECT * FROM usuarios_clube where sexo='Masculino' ORDER BY id ASC");
...
file_put_contents('Funcoes/Gato.txt', $_POST['id']);
?>
<div class="sucess">Gato alterado com sucesso!</div>
<? }} ?>

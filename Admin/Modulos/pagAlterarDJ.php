...
<div align="left">
      <blockquote>
        <h3><span class="style1">&nbsp;&nbsp;&raquo;&nbsp;</span>Alterar DJ </h3>
  </blockquote>
</div>
...
<?
$resultado = mysql_query("SELECT * FROM usuarios ORDER BY id ASC");
while($usuario = mysql_fetch_array($resultado)){
echo '<option value="' . $usuario['id'] . '"> ' . $usuario['nick'] . '</option>';}
?>
</select>
...
file_put_contents('Funcoes/Alt.txt', $_POST['id']);
?>
<div class="sucess">Locutor alterado com sucesso!</div>
<? } ?>
